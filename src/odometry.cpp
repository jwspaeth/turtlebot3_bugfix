...
: nh_(nh),
  ...
  publish_tf_(false),
  imu_angle_(0.0f),
  robot_pose_{ {0.0f, 0.0f, 0.0f} },
  robot_vel_{ {0.0f, 0.0f, 0.0f} },
  last_joint_positions_{ {0.0f, 0.0f} }
{
...
{
  diff_joint_positions_[0] = joint_state->position[0] - last_joint_positions_[0];
  diff_joint_positions_[1] = joint_state->position[1] - last_joint_positions_[1];

  last_joint_positions_[0] = joint_state->position[0];
  last_joint_positions_[1] = joint_state->position[1];
}
